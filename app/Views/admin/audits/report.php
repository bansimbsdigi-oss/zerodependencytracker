...
<div style="margin-bottom:1rem;">
  <a class="btn btn-secondary btn-sm" href="<?= APP_URL ?>/admin/clients/view/<?= $clientId ?>">&larr; Back to <?= e($session->client_name) ?></a>
</div>
...
<div class="report-panel active" id="panel-analytics">
  ...
  <div class="coach-fb">
    ...
    <div class="coach-fb-body">
      <form method="POST" action="<?= APP_URL ?>/admin/audits/report/<?= $sessionId ?>">
