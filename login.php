...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($mobileLocal) || strlen($mobileLocal) < 7) {
        ...
        if ($user) {
            ...
            $error = "This mobile number is not registered. Please check and try again.";
        }
    }
}
?>
...
<head>
  ...
  <style>
    ...
    @media (max-width: 900px) {
        ...
        .split-left { flex: none; width: 100%; box-sizing: border-box; padding: 2rem 1.25rem 1.5rem; align-items: flex-start; text-align: left; justify-content: flex-start; background-color: #0f8574; }
        ...
        .auth-form-container p.desc { font-size: 0.88rem; margin-bottom: 1.25rem; }
    }
