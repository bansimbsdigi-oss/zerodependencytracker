...
adminPageStart('All Clients', 'clients');
?>
<?php if (hasPermission('register_clients')): ?>
  <div class="admin-page-action">
    <a class="admin-action-btn primary" href="<?= APP_URL ?>/admin/clients/create.php">+ Add Client</a>
  </div>
<?php endif; ?>
  ...
  <section class="admin-client-hero">
    ...
    <div class="admin-client-hero-actions">
      <?php if (hasPermission('edit_clients')): ?>
        <a class="admin-action-btn" href="<?= APP_URL ?>/admin/clients/edit.php?id=<?= $featured->id ?>">Edit</a>
      <?php endif; ?>
      <a class="admin-action-btn outline" href="<?= APP_URL ?>/admin/clients/view.php?id=<?= $featured->id ?>">View Report</a>
    </div>
  </section>
<?php endif; ?>
        ...
        <tr data-client-row>
          ...
          <td>
            <div class="admin-row-actions">
              <?php if (hasPermission('edit_clients')): ?>
                <a class="admin-row-btn" href="<?= APP_URL ?>/admin/clients/edit.php?id=<?= $c->id ?>">Edit</a>
              <?php endif; ?>
              <a class="admin-row-btn outline" href="<?= APP_URL ?>/admin/clients/view.php?id=<?= $c->id ?>">View</a>
            </div>
          </td>
        </tr>
      <?php endforeach; ?>
